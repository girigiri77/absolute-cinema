export type Movie = {
  ...
  currentSeason?: number; // for series (latest season released)
  currentSeasonEpisodeCount?: number; // for series (number of episodes in current season)
  episodeRuntime?: number; // minutes (for series, average episode runtime)
